...
class _UsePromoPageState extends State<UsePromo> {
  ...
  Future<Map<String, dynamic>> fetchPromo(String restaurantId) async {
    ...
    final response = await request
        .get('${AppConfig.apiUrl}/promo/mobile_use_promo/$restaurantId/');
  ...
  Future<void> tagPromo(int promoId) async {
    ...
    final response = await request.post('${AppConfig.apiUrl}/promo/tag_promo/',
      ...
      body: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (data == null ||
                  !data.containsKey('promos') ||
                  !data.containsKey('other_promos')) {
                return const Center(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          final response = await request.get(
                              '${AppConfig.apiUrl}/promo/find_by_code/$promoCode/');
                          ...
                          if (response == null ||
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Promo code not found')),
                            );
                            return;
                          }
                                  ...
                                  children: [
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        final request =
                                            authProvider.cookieRequest;

                                        try {
                                          final response = await request.get(
                                              '${AppConfig.apiUrl}/promo/tag_promo/?promo_id=${promoDetails['id']}');
